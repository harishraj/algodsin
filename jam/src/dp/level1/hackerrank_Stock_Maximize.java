...
public class hackerrank_Stock_Maximize {
	public static void main(String[] args) {
	}

	public static void max(int[] arr) {
		// The idea behind this is iterating arr from right to left and
		// recording the localMax.
		// You always want to buy stocks at low prices and sell them at high,
		// which means higher
