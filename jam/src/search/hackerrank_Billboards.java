...
public class hackerrank_Billboards {
	public static void main(String[] args) {
		...
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 0) == 0);
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 1) == 15);
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 2));
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 3));
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 4));
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 5));
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 6));
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 7));
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 8));
		System.out
				.println(billboard(new int[] { 3, 2, 1, 4, 5, 6, 3, 4, 5 }, 9));
	}
	...
	public static long billboard(int[] arr, int k) {
		...
		long sum = 0;
		long[] local = new long[] { Integer.MAX_VALUE, 0 }; // local[0];
															// localMin
															// local[1]:
															// localMinIndex
	...
	public static void updateLocalMin(long[] local, long[] status, int start,
			int end) {
		if (start == 0 || local[1] == start - 1) {
			// Sliding window just passed localMin or sliding window hasn't been
			// initialized.
			// Rescan new window.
			...
			local[1] = end; // Index update. When status[end] == local[0], index
							// updated to right most.
