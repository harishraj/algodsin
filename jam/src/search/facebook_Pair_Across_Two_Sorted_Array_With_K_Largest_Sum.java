...
public class facebook_Pair_Across_Two_Sorted_Array_With_K_Largest_Sum {
	...
	/**
	 * Time complexity O(lg k * k). The idea is more like level-order traversal.
	 * When you have pair(x, y) then the next smaller pair is either pair(x - 1,
	 * y) or pair(x, y - 1) Using max heap to keep the element inserted sorted.
	 */
