...
class google_Range_Minimum_Query {
	public static void main(String[] args) {
		int[] input = new int[] { 9, 5, 1, 2, 0, -1, 3, 6, 4, 10, 11, 7, -2, 8,
				-3 };
	...
	public static int[][] noBrainer(int[] A) {
		...
		// Space complexity O(N^2), Status matrix creation time complexity
		// O(N^2)
...
class SegmentTreeMin {
	...
	public int buildSegmentTree(int[] arr, int start, int end, int[] STree,
			int index) {
		if (start == end) {
