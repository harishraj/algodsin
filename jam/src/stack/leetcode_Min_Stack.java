 ...
 * 
 * if not self._min or self._min[-1] >= x: self._min.append(x)
 * 
 * def pop(self): """""" x = self._s.pop() if self._min[-1] == x:
 * self._min.pop()
 * 
 * def top(self): """""" return self._s[-1]
 * 
 * def getMin(self): return self._min[-1]
 */
