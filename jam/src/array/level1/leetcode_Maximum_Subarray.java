...
/*
 * Python Version def maxSubArray(self, A): if not A: return 0
 * 
 * all_neg = True max_val = 0 acc = 0 for val in A: all_neg = False if val > 0
 * else all_neg acc += val if acc < 0: acc = 0 max_val = max(max_val, acc)
