...
class leetcode_First_Missing_Positive {
	...
	public static int firstMissingPositive(int[] A) {
		...
		// bool[0] is wasted because here the index is considered as potential
		// missing int.
...
/*
 * Python Version def firstMissingPositive(self, A): s = set([ i for i in
 * xrange(1, len(A) + 1)]) for val in A: if val in s: s.remove(val)
 * 
