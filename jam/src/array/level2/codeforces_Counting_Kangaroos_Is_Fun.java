...
public class codeforces_Counting_Kangaroos_Is_Fun {
	 ...
	 * O(nlgn) solution.
	 * 
	 * The worst case scenario is n, that is none of them matches, like 1, 1, 1,
	 * 1 The best case scenario is n / 2, that is they match as many as
	 * possible. Sort first. And try to find pairs starting at index i and mid.
	 * 
