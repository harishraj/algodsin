...
public class Continental_Divide {
	 ...
	 * 
	 * BFS from both of the borders and find the intersection of points that can
	 * flow to both of the borders.
	 */
	public static void main(String[] args) {
		Continental_Divide solution = new Continental_Divide();
		// Geo.
		int[][] geo = new int[][] { { 3, 2, 6, 8, 1 }, { 7, 2, 3, 2, 1 },
				{ 4, 5, 4, 6, 8 }, { 2, 7, 5, 3, 5 }, { 1, 1, 1, 1, 1 }, };
