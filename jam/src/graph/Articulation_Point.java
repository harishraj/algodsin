...
class APGraph {
	...
	public void AP() {
		/*
		 * :param boolean[] visited: :param boolean[] ap: Store articulation
		 * points. :param int[] disc: Stores discovery times of visited
		 * vertices. :param int[] low: is the lowest dfs# of any vertex that is
		 * either in the dfs subtree rooted at v (including v itself) or
		 * connected to a vertex in that subtree by a back edge. :param int[]
