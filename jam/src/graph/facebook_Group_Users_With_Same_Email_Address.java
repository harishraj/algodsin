...
public class facebook_Group_Users_With_Same_Email_Address {
	...
	public void solve() {
		...
		input.add(new User("Johnny", new String[] { "john@gmail.com",
				"john@yahoo.com", "john@hotmail.com" }));
	...
	public ArrayList<ArrayList<User>> groupUserWithSameEmail(
	...
	/* DFS logic. */
	public ArrayList<ArrayList<Integer>> dfs(boolean[][] adjacencyMatrix,
			int n, ArrayList<User> nodes) {
