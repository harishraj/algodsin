...
/**
 * leetcode_Linked_List_Cycle_II. Given a linked list, return the node where the
...
public class leetcode_Linked_List_Cycle_II {
	...
	public static ListNode detect(ListNode head) {
		...
		// Assuming: # of nodes before cycle begins is x, # of nodes in cycle
		// and # of nodes
		// slow visited in cycle. Then you have:
		// (x + t) * 2 = x + y + t. Then you got: x + t = y
		// Since slow/fast is at t, when you travel at the same speed with head,
		// they meet at
