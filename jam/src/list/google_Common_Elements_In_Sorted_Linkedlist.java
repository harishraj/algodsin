...
public class google_Common_Elements_In_Sorted_Linkedlist {
	...
	/**
	 * The solution is based on merge sort. If two lengths are very close then
	 * merge sort will do. If one is extremely large then then the shorted one
	 * reach the end, then it can stop. Worst time complexity O(m + n)
	 */
