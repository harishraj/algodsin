...
public class Is_Point_Inside_Polygon_Jarvis {
	...
	/*
	 * Given the Is_Two_Line_Segments_Intersect function, we can implement this
	 * easily.
	 */
	...
	public static void main(String[] args) {
		// test case 1.
		Point[] polygon1 = new Point[] { new Point(0, 0), new Point(10, 0),
		...
		// test case 3.
		polygon1 = new Point[] { new Point(0, 0), new Point(5, 5),
				new Point(5, 0) };
		p = new Point(3, 3);
		System.out.println(isPointInsidePolygon(polygon1, p));
		// test case 4.
