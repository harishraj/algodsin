 ...
 * 
 * Compare two version numbers version1 and version1. If version1 is larger than
 * version2 return 1, if version1 is smaller than version2 return -1, otherwise
 * return 0.
 * 
 * You may assume that the version strings are non-empty and contain only digits
 * and the '.' character. The '.' character does not represent a decimal point
 * and is used to separate number sequences. For instance, 2.5 is not
