...
public class Find_kth_Largest_In_Array {
	...
	/**
	 * This solution is based on quickSort. Another working solution is heap but
	 * it's trivial.
	 */
	...
	private static int kthSmallest(int[] arr, int left, int right, int i) {
		...
		// In this special case we only care that kth largest element is at kth
		// position.
		// The first k-1 elements do not need to be sorted so do all the element
		// after k.
