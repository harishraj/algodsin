...
public class Stable_Marriage_Problem {
	...
	/*
	 * Input definition: prefer[][] with 2 * N women and men. prefer[0:N - 1] is
	 * men's preference list and prefer[N:2 * N - 1] is women's. for a specific
	 * man/woman prefer[i] is a int array with length N and elements are indexes
	 * for preferred women/men in order.
	 */
