...
public class google_BST_Serialization_Deserialization {
	 ...
	 * 
	 * And it's not neccessary to be binary search tree. It applies to binary
	 * tree.
	 */
	...
	private static void test() {
		...
		Collections.addAll(nodes, "30", "10", "50", "#", "#", "#", "20", "45",
				"#", "#", "35", "#", "#");
	 ...
	 * Serialization.
	 * 
	 * Can be in-order, can be pre-order or post-order as long as it is
