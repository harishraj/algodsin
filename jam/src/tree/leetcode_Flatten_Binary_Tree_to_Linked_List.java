...
public class leetcode_Flatten_Binary_Tree_to_Linked_List {
	...
	// This is the solution i came up with recently. Way better than the one
	// below.
	...
	public static void myFlatten(TreeNode root) {
		...
		root.left = null;
		// Right the last node of linked copied to right and connect it with the
		// right linkedlist.
...
/*
 * Python Version def flatten(self, root): if not root: return
 * 
 * right = root.right left = root.left root.left = None root.right = left
 * 
 * cursor = root
 * 
