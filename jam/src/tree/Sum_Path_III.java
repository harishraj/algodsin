...
public class Sum_Path_III {
	...
	public static HashMap<Integer, ArrayList<ArrayList<Integer>>> dfs(
	...
	public static void cookNewSubroute(
			HashMap<Integer, ArrayList<ArrayList<Integer>>> ret,
			HashMap<Integer, ArrayList<ArrayList<Integer>>> side, int root) {
	...
	public static void stdoutOneSide(ArrayList<ArrayList<Integer>> side,
			int root, boolean isLeftSubtree) {
		if (side == null) {
			return;
		}
	...
	public static void stdout(ArrayList<ArrayList<Integer>> left,
			ArrayList<ArrayList<Integer>> right, int root) {
