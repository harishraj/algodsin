...
/*
 * Python Version def inorderTraversal(self, root): stack = [] ret = [] while
 * root or stack: if root: stack.append(root) root = root.left else: root =
 * stack.pop() ret.append(root.val) root = root.right
 * 
 * return ret
 */
