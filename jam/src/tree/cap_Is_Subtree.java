...
class cap_Is_Subtree {
	...
	/**
	 * We can preorder traverse both of the tree and construct string
	 * representation of both trees.
	 * 
	 * Then we can check if a string is the substring of other. But given two
	 * large binary trees, the string will consumes a lot of extra memory.
	 * 
