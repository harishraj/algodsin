...
/**
 * facebook_Next_Node_In_Binary_Search_Tree. facebook.
 * 
...
public class facebook_Next_Node_In_Binary_Search_Tree {
	 ...
	 * 
	 * case 1: root.right != null Find the left-most child of the root.right
	 * 
	 * case 2: root.right == null && root.parent == null Return null.
	 * 
	 * case 3: root.right == null && root.parent.left == root Return
	 * root.parent.
	 * 
	 * case 4: root.right == null && root.parent.right == root Trace back till
	 * the first left child relationship. Return parent.
	 */
