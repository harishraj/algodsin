...
public class google_Securitie_Guarding_Doors {
	...
	public static void main(String[] args) {
		// Test cases.
		char[][] map = new char[][] { { '0', '0', '0' }, { 'B', 'G', 'G' },
				{ 'B', '0', '0' }, };
		solve(map);
	}

	/*
	 * A solution with time complexity O(n^2) Using bfs with all guards as
	 * starting points. *Warning* Haven't tested yet.
	 */
	...
	public static void bfs(ArrayList<coordinates> all, char[][] map, int N,
			int M) {
