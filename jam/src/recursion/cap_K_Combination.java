...
public class cap_K_Combination {
	...
	public static void kConbinationUtil(String acc, String str, int k,
		...
		if (k == 0) {
			...
			// Skip the first char as long as the length of the string is larger
			// than k.
			// Otherwise rest of the string can not even sum up to a k-length
			// conbination.
			if (k < str.length()) {
