...
public class Boggle {
	...
	public static void testSuite2() {
		...
		Collections.addAll(dict, "cat", "cate", "apple", "pear", "haha",
				"great");
		char[][] board = { { 'a', 'b', 'c', 'd' }, { 'v', 'r', 'a', 'f' },
				{ 'j', 't', 'e', 'p' }, { 'k', 'g', 'r', 'o' } };
		long t1 = System.currentTimeMillis();
		System.out.println(boggleWithTrie(board, dict));
		System.out.println("Time cost of testSuite2: "
	...
	public static void testSuite1() {
		...
		System.out.println("Time cost of testSuite1: "
				+ (System.currentTimeMillis() - t1) / 1000.0 + " secs");
	}
