...
public class cap_Coins_Change {
	...
	/*
	 * Dynamic programming based solution. for (int i = 1; i <= value; ++i) for
	 * (int value : set) if (value <= i) dp[i] += dp[i - value] This dp
	 * relationship is not correct because the order of cents does not matter.
	 * The outer loop should be different types of coins.
	 */
	...
	public static void nextCoin(int val, int[] set, int index,
			ArrayList<int[]> all, int[] count) {
