...
public class Tug_of_War {
	public static void main(String[] args) {
		...
		solution.solve();
		solution = new TugOfWar(new int[] { 23, 45, -34, 12, 0, 98, -99, 4,
				189, -1, 4 });
		solution.solve();
		solution = new TugOfWar(
				new int[] { 3, 4, 5, -3, 100, 1, 89, 54, 23, 20 });
		solution.solve();
	}
}
...
class TugOfWar {
	...
	TugOfWar(int[] arr) { // Constructor.
		...
		this.ret = new int[this.n / 2]; // Global array storing current best
										// solution.
		this.sum = getSum(arr);
