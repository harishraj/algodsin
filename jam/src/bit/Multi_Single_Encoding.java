 ...
 * 
 * Encoding is defined as follow: 1. Single encoding: One byte to represent a
 * string, this byte must be in range [-128, 0)
 * 
 * 2. Multiple encoding: Two bytes to represent a string, the first byte must be
 * in range [0, 127] and the second byte must be in range [-128, 127]
 * 
 * It is guaranteed that the byte array is valid for this encoding rule.
 * 
 * Question: It the last string multiple encoding or single encoding?
 */
