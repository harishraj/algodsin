...
public class cap_Bits_Combination_And_Mapping {
	...
	public static void main(String[] args) {
		...
		// 10100
		// 11000
		String[] testSuite = new String[] { "00011", "00101", "00110", "01001",
				"01010", "01100", "10001", "10010", "10100", "11000" };
	...
	public static String getNumberUtil(String acc, int oneNum, int zeroNum,
			int index) {
		if (zeroNum == 0) {
			...
			if (index >= thredhold) {
				return getNumberUtil(acc + "1", oneNum - 1, zeroNum, index
						- thredhold);
			} else {
	...
	public static int getIndexUtil(String num, int oneNum, int zeroNum,
			int index) {
