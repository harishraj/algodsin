...
public class cap_Missing_Integer {
	...
	/*
	 * The removal of one number will cause the inbalance of least significant
	 * bit(lsb).
	 * 
	 * If n is odd, say, 5, then 0, 1, 2, 3, 4, 5. 000, 001, 010, 011, 100, 101
	 * lsb: 0, 1, 0, 1, 0, 1, remove number with lsb 0 or 1 if n is even, say,
	 * 6, then 0, 1, 2, 3, 4, 5, 6 000, 001, 010, 011, 100, 101, 110 lsb: 0, 1,
	 * 0, 1, 0, 1, 0, remove number with lsb 0 or 1. We can jump to the
	 * conclusion that: If we remove lsb 1, number of 0 is > number of 1. if we
	 * remove lsb 0, number of 0 is <= number of 1. Then according to the > or
	 * <= we know what lsb the removed number is with.
	 */
