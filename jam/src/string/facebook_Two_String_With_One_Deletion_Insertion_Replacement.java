...
/**
 * facebook_Two_String_With_One_Deletion_Insertion_Replacement. facebook.
 * 
 * Given Two String, write a fucntion that return true if one of the string can
 * be converted to another by one deletion/insertion/replacement operation.
...
public class facebook_Two_String_With_One_Deletion_Insertion_Replacement {
	...
	/**
	 * return true if two strings lengths diff by one and there is one and only
	 * one diff.
	 */
	...
	/**
	 * return true if two strings have same lengths and there is one and only
	 * one replacement.
	 */
	...
	/**
	 * return true if two strings are convertible by one
	 * deletion/insertion/replacement.
	 * 
	 * return yes if neither of strings is null and if length diff by one there
	 * is only insertion/deletion, or, if lengths are same then there is only
	 * one replacement.
	 */
	private boolean oneCharDiff(String s1, String s2) {
		return checkNull(s1, s2) && checkIfLengthDiffByOne(s1, s2)
