...
public class google_Verify_UTF8 {
	 ...
	 * 
	 * Return value : If the string is valid utf-8, 0 is returned. Else the
	 * position, starting from 1, is returned.
	 * 
	 * Valid utf-8 sequences look like this : 0xxxxxxx 110xxxxx 10xxxxxx
	 * 1110xxxx 10xxxxxx 10xxxxxx 11110xxx 10xxxxxx 10xxxxxx 10xxxxxx 111110xx
	 * 10xxxxxx 10xxxxxx 10xxxxxx 10xxxxxx 1111110x 10xxxxxx 10xxxxxx 10xxxxxx
	 * 10xxxxxx 10xxxxxx
	 */
	...
	public static int validUTF8(String str) {
		...
		while (i < arr.length && bytesSequence > 0 && arr[i] >= 0x80
				&& arr[i] <= 0xBF) {
			++i;
			bytesSequence -= 1;
		}
