...
class Max_Number_of_Cyclic_Automorphism {
	...
	public static int cyclicAutomorphism(String A) {
		...
		// 1. A.length() is even:
		// find the min i from 0 to A.length() that shifted is equal to
		// original.
		// Because the original string and shitfted one is mismatched by i
		// position.
		// then original string can be devided into i parts, and each part is
		// equal.
		// 2. A.length() is odd.
